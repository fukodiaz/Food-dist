window.addEventListener('DOMContentLoaded', () => {
	...
	function getDynamicInformation(selector) {
		const inputOfCalc = document.querySelector(selector);

		inputOfCalc.addEventListener('input', () => {

			if (inputOfCalc.value.match(/\D/g)) {
				inputOfCalc.style.border = '1px solid red';
			} else {
				inputOfCalc.style.border = 'none';
			}

			switch (inputOfCalc.getAttribute('id')) {
				case 'height':
					heigth = +inputOfCalc.value;
					break;
				case 'weight':
					weight = +inputOfCalc.value;
					break;
				case 'age':
					age = +inputOfCalc.value;
					break;
			}
